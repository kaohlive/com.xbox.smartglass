 ...
 */
exports.getAsn1Signature = function (encodedTbsCertificate, privateJwk, signatureAlgorithm) { return __awaiter(void 0, void 0, void 0, function () {
    var asn1sig;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, js_crypto_ec_1.default.sign(encodedTbsCertificate, privateJwk, params.signatureAlgorithms[signatureAlgorithm].hash, 'der')];
            case 1:
                asn1sig = _a.sent();
                return [2 /*return*/, { unused: 0, data: BufferR.from(asn1sig) }];
        }
    });
}); };
